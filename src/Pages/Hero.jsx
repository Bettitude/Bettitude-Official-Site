      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(20)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-2 bg-[#FFC527]/30 rounded-full animate-float"
              style={{
        ...
        <div className="absolute top-1/4 -right-48 w-96 h-96 bg-[#0057B8]/30 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 -left-48 w-96 h-96 bg-[#FFC527]/20 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[85vh]">
          ...
          <div className="space-y-10">
            <div className="inline-flex items-center space-x-3 px-5 py-3 bg-gradient-to-r from-[#0057B8]/30 to-[#FFC527]/30 backdrop-blur-xl border border-[#FFC527]/50 rounded-full shadow-lg shadow-[#FFC527]/20">
              <div className="relative">
                <div className="absolute inset-0 bg-[#FFC527] blur-md animate-pulse"></div>
                <div className="relative w-3 h-3 bg-[#FFC527] rounded-full"></div>
              </div>
              <span className="text-white text-sm font-bold tracking-wide">PREMIUM SPORTS CONTENT</span>
            </div>

            {/* Main Headline with Alternating Text - FIXED */}
            <div className="space-y-6">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight tracking-tight">
                <span className="block text-white animate-fade-in-up mb-2">
                  Feeding every
                </span>
              ...
              <div className="flex items-center space-x-3">
                <div className="h-2 w-32 bg-gradient-to-r from-[#FFC527] to-[#0057B8] rounded-full animate-expand"></div>
                <div className="h-1.5 w-20 bg-gradient-to-r from-[#0057B8] to-transparent rounded-full animate-expand" style={{ animationDelay: '0.2s' }}></div>
              </div>
            </div>

            <div className="space-y-6 max-w-2xl">
              <div className="flex items-center space-x-3 mb-4">
                <div className="h-0.5 w-12 bg-[#FFC527]"></div>
                <p className="text-[#FFC527] font-bold text-lg tracking-wider uppercase">
                  Sports Content Curated For
                </p>
              </div>
              
              <p className="text-xl lg:text-2xl text-[#E0E0E0] leading-relaxed font-light">
              ...
              <p className="text-lg lg:text-xl text-[#E0E0E0]/90 leading-relaxed font-light">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              {['Match Analysis', 'Live Updates', 'Expert Insights', 'Community'].map((feature, idx) => (
                <div
                  key={idx}
                  className="group px-6 py-3 bg-gradient-to-r from-[#0057B8]/20 to-[#0057B8]/10 backdrop-blur-sm border border-[#0057B8]/40 rounded-full hover:border-[#FFC527]/60 transition-all duration-300 hover:scale-105"
                  style={{ animationDelay: `${idx * 0.1}s` }}
                >
                  <span className="text-[#E0E0E0] group-hover:text-[#FFC527] font-semibold text-sm transition-colors duration-300">
                    {feature}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col sm:flex-row gap-5 pt-6">
               ...
               <a href="/product" className="group relative px-10 py-6 bg-gradient-to-r from-[#FFC527] to-[#ffb700] text-[#0B0F19] font-black rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-[#FFC527]/50 hover:scale-105 text-center text-lg"
 >
            ...
            <div className="flex items-center space-x-8 pt-8 pb-4">
              <div className="flex items-center space-x-3">
                <div className="relative">
                  <div className="absolute inset-0 bg-[#FFC527] blur-lg animate-pulse"></div>
                  <FiUsers className="relative text-[#FFC527] text-3xl" />
                </div>
                <div>
                  <p className="text-white font-black text-2xl">25M+</p>
                  <p className="text-[#E0E0E0] text-sm">Global Fans</p>
                </div>
              </div>
              
              <div className="h-12 w-px bg-[#0057B8]/30"></div>
              
              <div className="flex items-center space-x-3">
                <div className="relative">
                  <div className="absolute inset-0 bg-[#0057B8] blur-lg animate-pulse"></div>
                  <FiGlobe className="relative text-[#0057B8] text-3xl" />
                </div>
                <div>
                  <p className="text-white font-black text-2xl">50+</p>
                  <p className="text-[#E0E0E0] text-sm">Countries</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 flex space-x-3 z-20">
        {slides.map((_, index) => (
          <button
            ...
            className={`transition-all duration-500 rounded-full ${
              index === currentSlide 
                ? 'w-16 h-3 bg-gradient-to-r from-[#FFC527] to-[#ffb700] shadow-lg shadow-[#FFC527]/50' 
                : 'w-3 h-3 bg-[#E0E0E0]/30 hover:bg-[#E0E0E0]/60'
            }`}
          />
        ))}
      </div>
