      ...
      <div className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center space-y-8 py-30">
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#0057B8]/20 backdrop-blur-sm border border-[#0057B8]/50 rounded-full">
            <FiMail className="text-[#FFC527] text-sm" />
            <span className="text-[#E0E0E0] text-sm font-semibold">Get In Touch</span>
          </div>
      ...
      <div className="relative py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
              ...
              >
                ...
                <div className="relative space-y-6">
                  <div className="relative">
                    ...
                    <div className={`relative w-16 h-16 bg-gradient-to-br ${info.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                      <info.icon className="text-[#0B0F19] text-3xl" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-[#E0E0E0] leading-relaxed min-h-[60px]">
                      {info.description}
                    </p>
                  </div>
                  ...
                  <a
                    ...
                    className="group/email flex items-center space-x-2 text-[#FFC527] font-semibold hover:translate-x-2 transition-transform duration-300"
                  >
                  ...
                  <a
                    href={`mailto:${info.email}`}
                    className="block px-4 py-3 bg-[#0057B8]/20 backdrop-blur-sm border border-[#0057B8]/30 rounded-xl text-white font-bold hover:bg-[#0057B8]/40 hover:border-[#FFC527]/50 transition-all duration-300"
                  >
                    {info.email}
                  </a>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div className="relative bg-gradient-to-br from-[#0057B8]/10 to-[#0B0F19]/50 backdrop-blur-xl border border-[#0057B8]/30 rounded-3xl p-8 lg:p-12 hover:border-[#FFC527]/50 transition-all duration-500">
              <div className="absolute inset-0 bg-gradient-to-br from-[#FFC527]/0 to-[#FFC527]/0 hover:from-[#FFC527]/10 hover:to-[#0057B8]/10 rounded-3xl transition-all duration-500 pointer-events-none"></div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-5 py-4 bg-[#0B0F19]/80 border-2 border-[#0057B8]/50 rounded-xl text-white placeholder-[#E0E0E0]/50 focus:border-[#FFC527] focus:outline-none transition-colors duration-300"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-5 py-4 bg-[#0B0F19]/80 border-2 border-[#0057B8]/50 rounded-xl text-white placeholder-[#E0E0E0]/50 focus:border-[#FFC527] focus:outline-none transition-colors duration-300 resize-none"
                      required
                    />
                  </div>
                  ...
                  <button
                    ...
                    className={`group w-full flex items-center justify-center space-x-2 px-8 py-5 rounded-xl font-bold transition-all duration-300 ${
            ...
            <div className="space-y-8">
              {/* Social Media */}
              <div className="relative bg-gradient-to-br from-[#FFC527]/10 to-[#0B0F19]/50 backdrop-blur-xl border border-[#FFC527]/30 rounded-2xl p-8 hover:border-[#FFC527]/50 transition-all duration-500">
                <div className="space-y-6">
                  ...
                  <div className="flex space-x-4">
                    {socialLinks.map((social, idx) => (
                      <a
                        ...
                        className="w-16 h-16 bg-[#0057B8]/20 backdrop-blur-sm border border-[#0057B8]/30 rounded-xl flex items-center justify-center text-[#E0E0E0] hover:text-[#FFC527] hover:border-[#FFC527]/50 hover:scale-110 transition-all duration-300"
                      >
              ...
              <div className="relative bg-gradient-to-br from-[#0057B8]/10 to-[#0B0F19]/50 backdrop-blur-xl border border-[#0057B8]/30 rounded-2xl p-8 hover:border-[#FFC527]/50 transition-all duration-500">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {additionalInfo.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-start space-x-4 bg-[#0057B8]/10 backdrop-blur-sm border border-[#0057B8]/30 rounded-xl p-4 hover:border-[#FFC527]/50 transition-all duration-300"
                      >
                        <div className="w-12 h-12 bg-gradient-to-br from-[#FFC527] to-[#ffb700] rounded-lg flex items-center justify-center flex-shrink-0">
                          <item.icon className="text-[#0B0F19] text-xl" />
                        </div>
                        <div>
              ...
              <div className="relative bg-gradient-to-r from-[#0057B8]/20 via-[#FFC527]/10 to-[#0057B8]/20 backdrop-blur-xl border border-[#0057B8]/30 rounded-2xl p-6">
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#FFC527] to-[#ffb700] rounded-full flex items-center justify-center">
                    <FiCheckCircle className="text-[#0B0F19] text-3xl" />
                  </div>
                  <div>
                    <p className="text-white font-bold text-lg">Quick Response</p>
                    <p className="text-[#E0E0E0] text-sm">We typically respond within 24 hours</p>
                  </div>
                </div>
              </div>
            </div>
